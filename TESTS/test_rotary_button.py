...
def main():
    ...
    log(INFO, '*************************************')
    log(INFO, '* Starting Rotary Button testing... *')
    log(INFO, '*************************************')
    log(INFO, '')
    ...
    while True:
        ...
        if current_value != last_value:
            log(INFO, 'Current value: {}'.format(current_value))
            last_value = current_value

        current_move = button.get_move()

        if current_move != last_move:

            if current_move == rotarybutton.RotaryButton.TURNED_TO_THE_RIGHT:
                log(INFO, 'Button turned to the right')
            elif current_move == rotarybutton.RotaryButton.DID_NOT_TURN:
                log(INFO, 'Button no longer moves')
            else:
                log(INFO, 'Button turned to the left')
        ...
        if user_input_string == QUIT_COMMAND:
            ...
            log(INFO, '')
            log(INFO, '**************************************')
            log(INFO, '* Done with Rotary Button testing... *')
            log(INFO, '**************************************')
